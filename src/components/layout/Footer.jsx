        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">UniPlus</span>
            </Link>
            ...
            <div className="mt-6 flex space-x-3">
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="h-9 w-9 rounded-full bg-muted flex items-center justify-center transition-colors hover:bg-uniplus-100"
                aria-label="Twitter"
              >
